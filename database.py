...
class DB:
    ...
    @retry(stop_max_attempt_number = config.retry_mysql, stop_max_delay=config.timeout_db*1000, wait_exponential_multiplier=config.slience_http_multiplier*1000)
